...
// Must match the schema defined in Graph.tsx
...
export class DataManipulator {
  static generateRow(serverResponds: ServerRespond[]) {
    ...
    return {
      ...
      price_def: priceDEF,
      ratio,
      // timestamp is the latest timestamp between the two stocks
      timestamp:
      ...
      // trigger_alert is the ratio if it is out of bounds, otherwise it is undefined
      trigger_alert:
